...
public class CommentController {
    ...
    public CommentResponseDto createComment(@PathVariable Long id, String content, HttpServletRequest request) {
        return commentService.createComment(id, content, request);
    }

    @PutMapping("/comment/{id}")
    public CommentResponseDto updateComment(@PathVariable Long id, CommentRequestDto commentRequestDto, HttpServletRequest request) {
